...
export class ReporteAjusteService {
  ...
  constructor(_http: HttpClient) { 
    ...
    this.filterObj = new ReporteAjusteModel();
  }
  ...
  save(model: ReporteAjusteModel): Promise<ReporteAjusteModel> {
    console.log(model);
    return this.apiservice.consume(`${this.baseUrl}/reglaVencimiento/registrar`, model, "post");
  }

  update(model: ReporteAjusteModel): Promise<ReporteAjusteModel> {
    return this.apiservice.consume(`${this.baseUrl}/reglaVencimiento/editar`, model, "put");
  }

  updateFieldEstado(model: ReporteAjusteModel): Promise<ReporteAjusteModel> {
    return this.apiservice.consume(`${this.baseUrl}/reglaVencimiento/cambiarEstado`, model, "put");
  }

  list(): Promise<Array<ReporteAjusteModel>> {
    return this.apiservice.consume(`${this.baseUrl}/reporteAjustes/obtener`, {
      'filtroEstado': "1",
  ...
  reporteAjustesExcel(): Promise<any> {
    return this.apiservice.consume(`${this.baseUrl}/reporteAjustes/descargarAjustes`, {
      'filtroEstado': '1',
      'pagina': 1,
