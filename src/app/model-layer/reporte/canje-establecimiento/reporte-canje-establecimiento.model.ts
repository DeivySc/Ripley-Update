...
export class ReporteCanjeEstablecimientoModel {
  declare id:string;
  ...
  declare tipoReporte: string;
  declare filtroEstablecimientoCanje: string;
  declare filtroSucursalEmision: string;
  declare filtroPromotora: string;
  ...
  constructor(){
    ...
    this.fechaFin = "";
    this.tipoReporte = "";
    this.filtroEstablecimientoCanje = "";
    this.filtroSucursalEmision = "";
    this.filtroPromotora = "";
  }
}