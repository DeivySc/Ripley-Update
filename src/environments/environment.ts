...
export const environment = {
  ...
  //BASE_BACKEND: 'https://ripleypoints-dev-pwa.wespinoza.workers.dev/backendapi',
  BASE_BACKEND: 'http://localhost:8071',
  CLIENT_ID: 'ripleypoints_pwa',
  CLIENT_SECRET: 'cmlwbGV5cG9',
  RECAPTCHA_SITE_KEY: '6LdH5dMaAAAAAPSoLqNemHaB4sfQsCZQUT7dJl85',
  PUBLIC_KEY_BACKEND:
		'-----BEGIN PUBLIC KEY-----\
